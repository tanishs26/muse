    ...
    <div className="w-full  bg-neutral-950/50 flex justify-between h-18 items-center ">
      ...
      {user ? (
        <div className="flex justify-center items-center mr-4">
          ...
          <Button className="bg-orange-600 text-white/50 border-0 w-[50px] h-[50px] p-3 relative rounded-full overflow-hidden">
            {img ? (
              <Image
                src={img}
                alt="User avatar"
        ...
        <div>
          ...
          <Button
            className="mr-3  border-orange-500 antialiased "
